...
static struct vfs_executable_data namespace_executable_data[5];
static struct vfs_node namespace_executable_nodes[5];
...
static struct vfs_namespace_entry namespace_bin_entries[6];
